...
class PaypalPayment implements IPayPalPayment
{
    ...
    public function pay($data)
    {
        ...
        try {$payment->create($this->_api_context);notify()->success('Payment has been successfully processed');} catch (\PayPal\Exception\PPConnectionException $ex) {if (\Config::get('app.debug')) {\Session::put('error', 'Connection timeout');
