...
class PropertyController extends Controller
{
    ...
    public function __construct(IPackageUserModel $packageUserModel,IPropertyModel $propertyModel, IPropertyTranslationModel $propertyTranslationModel, ICategoryTranslationModel $categoryTranslationModel,IFacilityTranslationModel $facilityTranslationModel,ICountryTranslationModel $countryTranslationModel,IStateTranslationModel $stateTranslationModel,ICityTranslationModel $cityTranslationModel)
    {
...
//        $this->middleware('isApprove', ['only' => ['edit','update']]);
    ...
    public function create()
    {
        ...
        return view('admin.properties.create',compact('categories','facilities','packages','countries'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.properties.edit',compact('property','user','categories','facilities','package_user','packages','countries','states','cities','locale','propertyTranslation'));
    }
