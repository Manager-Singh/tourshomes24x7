                        ...
                        <div class="sidebar-left">
                            ...
                            <div class="widget categories">
                                ...
                                <ul class="icon">
                                    ...
                                    <li><a href="#">{{$popularTopic->blogCategoryTranslation->name ?? $popularTopic->blogCategoryTranslationEnglish->name  ?? null }}</a><span>({{$popularTopic->blogs->count()}})</span></li>
                                    @endforeach
                                </ul>
                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="page-prev">
                                                    <a href="#">
                                                        ...
                                                        <p>The Most luxurious way to spend your vacation</p>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="page-next">
                                                    <a href="#">
                                                        <span>Next Post</span>
                                                        <p>Why you should rent Harfold Villas</p>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
