                                        ...
                                        <ol class="carousel-indicators  list-gallery-thumb">
                                            ...
                                            @foreach($pic as $key=>$p)
                                                ...
                                                <li data-target="#carousel-thumb" data-slide-to="{{$key}}">
                                                    <img loading="lazy" class="img-fluid d-block w-100" src="{{ URL::asset("storage/gallery/".$p)}}" alt="...">
                                                </li>
                                                ...
                                                <div class="property-item">
                                                    ...
                                                    <div class="property-author-wrap">
                                                        ...
                                                        <div class="featured-price">
                                                            ...
                                                            @if($featuredProperty->type == 'sale') <p><span class="per_sale">starts from</span>${{$featuredProperty->price}}</p> @endif

                                                            @if($featuredProperty->type == 'rent') <p>${{$featuredProperty->price}}<span class="per_month">month</span></p> @endif
                                            ...
                                            <div class="single-property-box">
                                                ...
                                                <div class="property-title-box">
                                                    ...
                                                    <div class="trending-bottom trend-open">
                                                        @if($similarListing->type == 'sale') <p><span class="per_sale">starts from</span>${{$similarListing->price}}</p> @endif

                                                        @if($similarListing->type == 'rent') <p>${{$similarListing->price}}<span class="per_month">month</span></p> @endif
                                                    </div>
