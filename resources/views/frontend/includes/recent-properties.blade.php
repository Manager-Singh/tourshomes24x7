                        ...
                        <div class="single-property-box">
                            ...
                            <ul class="property-feature">
                                <li> <i class="las la-bed"></i>
                                    <span>{{$propertyDetails[$property->id]->bed}} Bedrooms</span>
                                </li>
                                <li> <i class="las la-bath"></i>
                                    <span>{{$propertyDetails[$property->id]->bath}} Bath</span>
                                </li>
                                <li> <i class="las la-arrows-alt"></i>
                                    <span>{{$propertyDetails[$property->id]->room_size}} sq ft</span>
                                </li>
                                <li> <i class="las la-car"></i>
                                    <span>{{$propertyDetails[$property->id]->garage}} Garage</span>
                                </li>
                            </ul>
